...
def app():
    ...
    st.write('The "manipulated" faces collected in this dataset are generated using the StyleGAN2, which present a harder challenge to classify them correctly even for the human eye.')

    st.image('./faces_1.png', use_container_width=True)
    st.image('./faces_2.png', use_container_width=True)
...
'''
    ...
    loss.image('./loss.png', use_container_width=True)
    acc.image('./accuracy.png', use_container_width=True)
